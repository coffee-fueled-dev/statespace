...
// Define the generic system using standard container configuration
...
// Generic element bank
export const genericElementBank = [
  "item_1",
  "item_2",
  "item_3",
  "item_4",
...
export const genericSystemConfig: StatespaceConfig = {
  name: "Generic System",
  description: "Basic generic container system with standard position types",
  containers: genericSystemTemplate,
  elementBank: genericElementBank,
};
